...
def is_government_website(url):
    ...
    government_domains = [
        '.gov/', '.gov.in/', '.gov.uk/', '.gov.au/', '.gov.ca/', '.gov.nz/', '.gov.za/','.co.in/','edu.in/','.org.in/','ac.in/','.net.in/','.gen.in/','.nic.in/','.nic.in','.gov', '.gov.in', '.gov.uk', '.gov.au', '.gov.ca', '.gov.nz', '.gov.za','.co.in','edu.in','.org.in','ac.in','.net.in','.gen.in'
...
def is_government_authorized_email(email):
    ...
    authorized_domains = [
        ".gov", ".gov.in", ".gov.uk", ".gov.au", ".gov.ca", ".gov.nz", ".gov.za",
